			...
			<section id="content" className={css.root}>
				<div className={css.content}>
					...
					{isDev ? (
						<>
							<p>
								Check that all the configuration assets are
								added to your marketplace environment through
								the Marketplace Console.
							</p>
							<p>
								Check also browser's developer tools for printed
								errors.
							</p>
						</>
					) : (
