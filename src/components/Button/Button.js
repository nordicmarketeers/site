...
const PlainButton = props => {
	...
	const onOverButton = enforcePagePreloadFor
		? onOverButtonFn(enforcePagePreloadFor)
		: null;
...
export const PrimaryButtonInline = props => {
	const classes = classNames(
		props.rootClassName || css.primaryButtonInlineRoot,
		css.primaryButton
	);
	return <Button {...props} rootClassName={classes} />;
};
...
export const SocialLoginButton = props => {
	const classes = classNames(
		props.rootClassName || css.socialButtonRoot,
		css.socialButton
	);
	return <Button {...props} rootClassName={classes} />;
};
