...
const DAY_AFTER_OVERMORROW = new Date(
...
const endDatePlaceholderText = formatDate(
	getStartOf(new Date(), "day", "Etc/UTC", 1, "days")
);
...
export const Empty = {
	...
	props: {
		...
		dateInputProps: {
			...
			onBlur: () =>
				console.log("onBlur called from DateRangeInput props."),
			onFocus: () =>
				console.log("onFocus called from DateRangeInput props."),
			isBlockedBetween: () => {
				return false;
			},
			isDayBlocked: () => {
...
export const InitialData = {
	...
	props: {
		...
		initialValues: {
			bookingDates: {
				startDate: OVERMORROW,
				endDate: DAY_AFTER_OVERMORROW,
			},
		},
	},
	group: "inputs",
