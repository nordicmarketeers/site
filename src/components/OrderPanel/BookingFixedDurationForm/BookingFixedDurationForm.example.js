...
const BookingFixedDurationForm = loadable(() =>
	import(
		/* webpackChunkName: "BookingFixedDurationForm" */ "./BookingFixedDurationForm"
	)
);
...
export const Form = {
	...
	props: {
		...
		initialValues: {
			bookingStartDate: {
				date: new Date(Date.UTC(currentYear, today.getUTCMonth(), 14)),
			},
		...
		onFetchTimeSlots: () =>
			Promise.resolve(() => console.log("onFetchTimeSlots called")),
