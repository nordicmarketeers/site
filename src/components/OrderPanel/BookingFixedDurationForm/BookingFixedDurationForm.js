...
const handleFetchLineItems = props => formValues => {
	...
	const seatsMaybe =
		seatsEnabled && seats > 0 ? { seats: parseInt(seats, 10) } : {};
...
export const BookingFixedDurationForm = props => {
	...
	const minDurationStartingInInterval = priceVariants.reduce(
		(min, priceVariant) => {
					...
					>
							...
							<FieldDateAndTimeInput
								...
								startDateInputProps={{
									label: intl.formatMessage({
										id:
											"BookingFixedDurationForm.bookingStartTitle",
									}),
						...
						{seatsEnabled ? (
							<FieldSelect
								...
								label={intl.formatMessage({
									id: "BookingFixedDurationForm.seatsTitle",
								})}
							...
							>
								<option disabled value="">
									{intl.formatMessage({
										id:
											"BookingFixedDurationForm.seatsPlaceholder",
									})}
								</option>
								{seatsOptions.map(s => (
