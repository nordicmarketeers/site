		...
		<FinalForm
			...
			render={formRenderProps => {
				...
				const submitDisabled =
					invalid || submitInProgress || !stripeConnected;

				return (
					<Form
						className={classes}
						onSubmit={handleSubmit}
						enforcePagePreloadFor="SaleDetailsPage"
					>
						<div className={css.section}>
							<Heading
								as="label"
								htmlFor={`${formId}quote`}
								rootClassName={css.sectionHeading}
							>
								<FormattedMessage
									id="MakeOfferPage.quoteLabel"
							...
							<FieldTextInput
								...
								placeholder={intl.formatMessage(
									{
										id:
											"MakeOfferPage.defaultMessagePlaceholder",
									},
									{ authorDisplayName }
								)}
							/>
