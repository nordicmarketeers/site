...
const makeOfferPayloadCreator = (
	...
	const orderData = offerInSubunits
		? { actor: "provider", offerInSubunits, currency }
		: {};
...
export const loadData = (params, search, config) => (
	...
	const transactionId = searchParams.transactionId
		? new UUID(searchParams.transactionId)
		: null;
	const state = getState();
	...
	const dataPromises = transactionId
		? [
				dispatch(showTransactionThunk({ transactionId, config })),
