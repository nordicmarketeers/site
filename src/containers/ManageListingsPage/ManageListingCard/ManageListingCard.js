		...
		<>
			...
			{isBookable ? (
				...
				>
					{currentStock == null
						? intl.formatMessage({
								id: "ManageListingCard.setPriceAndStock",
						  })
						: intl.formatMessage(
...
export const ManageListingCard = props => {
	...
	const { listingType, transactionProcessAlias, cardStyle } =
		publicData || {};
	...
	const hasStockManagementInUse =
		isProductOrder &&
		foundListingTypeConfig?.stockType === STOCK_MULTIPLE_ITEMS;
					...
					<div className={css.menubar}>
						<Menu
							className={classNames(css.menu, {
								[css.cardIsOpen]: !(isClosed || isDraft),
							})}
