...
describe("ManageListingCard", () => {
	it("Inquiry (inquiry): no price", () => {
		...
		expect(
			tree.getByText("ManageListingCard.closeListing")
		).toBeInTheDocument();
		expect(
			tree.queryByText("ManageListingCard.priceNotSet")
		).not.toBeInTheDocument();
		expect(
			tree.queryByText("ManageListingCard.price")
		).not.toBeInTheDocument(); //fakeIntl
		expect(tree.getByText(/the Listing/i)).toBeInTheDocument();
		expect(
			tree.getByText("ManageListingCard.editListing")
		).toBeInTheDocument();
		expect(
			tree.queryByText("ManageListingCard.manageAvailability")
		).not.toBeInTheDocument();
		expect(
			tree.queryByText("ManageListingCard.manageStock")
		).not.toBeInTheDocument();
	});
	...
	it("Booking (day): normal", () => {
		...
		expect(
			tree.getByText("ManageListingCard.manageAvailability")
		).toBeInTheDocument();
	});
	...
	it("Booking (day): closed", () => {
		...
		expect(
			tree.getByText("ManageListingCard.closedListing")
		).toBeInTheDocument();
		expect(
			tree.getByText("ManageListingCard.openListing")
		).toBeInTheDocument();
	});
	...
	it("Booking (day): pendingApproval", () => {
		...
		expect(
			tree.getByText("ManageListingCard.pendingApproval")
		).toBeInTheDocument();
	});
	...
	it("Booking (day): draft", () => {
		...
		expect(
			tree.getByText("ManageListingCard.draftOverlayText")
		).toBeInTheDocument();
		expect(
			tree.getByText("ManageListingCard.finishListingDraft")
		).toBeInTheDocument();
	});
	...
	it("Booking (day): no price", () => {
		...
		expect(
			tree.getByText("ManageListingCard.priceNotSet")
		).toBeInTheDocument();
		expect(tree.getByText(/the Listing/i)).toBeInTheDocument();
		expect(
			tree.getByText("ManageListingCard.editListing")
	...
	it("Purchase (item): normal", () => {
		...
		expect(
			tree.getByText("ManageListingCard.manageStock")
		).toBeInTheDocument();
	});
	...
	it("Purchase (item): normal out-of-stock", () => {
		...
		// Out of stock
		expect(
			tree.getByText("ManageListingCard.outOfStockOverlayText")
		).toBeInTheDocument();
		expect(
			tree.getByText("ManageListingCard.setPriceAndStock")
		).toBeInTheDocument();
		expect(
			tree.getByText("ManageListingCard.closeListingTextOr")
		).toBeInTheDocument();
	});
	...
	it("Purchase (item): oneItem", () => {
		...
		expect(
			tree.queryByText("ManageListingCard.setPriceAndStock")
		).not.toBeInTheDocument();
	});
