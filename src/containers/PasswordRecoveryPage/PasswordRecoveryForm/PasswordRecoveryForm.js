		...
		return (
			<FinalForm
				...
				render={fieldRenderProps => {
					...
					const customErrorText = isPasswordRecoveryEmailNotFoundError(
						recoveryError
					)
						? emailNotFoundMessage
						: null;
					const initialEmail = initialValues
						? initialValues.email
						: null;
					const emailTouched =
						values.email !== this.submittedValues.email;
					...
					return (
						...
						>
							<FieldTextInput
								...
								customErrorText={
									emailTouched ? null : customErrorText
								}
							/>
