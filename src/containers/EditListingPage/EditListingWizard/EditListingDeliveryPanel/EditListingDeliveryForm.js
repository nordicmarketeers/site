	...
	<FinalForm
		...
		render={formRenderProps => {
			...
			const shippingEnabled =
				displayShipping && values.deliveryOptions?.includes("shipping");
			const pickupEnabled =
				displayPickup && values.deliveryOptions?.includes("pickup");
			...
			const currencyConfig = appSettings.getCurrencyFormatting(
				marketplaceCurrency
			);
				...
				<Form className={classes} onSubmit={handleSubmit}>
					...
					<div className={pickupClasses}>
						...
						<FieldTextInput
							...
							placeholder={intl.formatMessage({
								id:
									"EditListingDeliveryForm.buildingPlaceholder",
							})}
							disabled={!pickupEnabled}
						/>
					</div>
					...
					<div className={shippingClasses}>
						<FieldCurrencyInput
							...
							label={intl.formatMessage({
								id:
									"EditListingDeliveryForm.shippingOneItemLabel",
							})}
							placeholder={intl.formatMessage({
								id:
									"EditListingDeliveryForm.shippingOneItemPlaceholder",
							})}
							...
							validate={
								shippingEnabled
									? required(
											intl.formatMessage({
												id:
													"EditListingDeliveryForm.shippingOneItemRequired",
											})
									  )
									: null
							}
