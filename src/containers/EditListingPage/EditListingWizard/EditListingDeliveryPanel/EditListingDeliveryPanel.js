			...
			{priceCurrencyValid ? (
				<EditListingDeliveryForm
					...
					onSubmit={values => {
						...
						const shippingEnabled = deliveryOptions.includes(
							"shipping"
						);
						const pickupEnabled = deliveryOptions.includes(
							"pickup"
						);
						const address =
							location?.selectedPlace?.address || null;
						...
						const shippingDataMaybe =
							...
							shippingPriceInSubunitsOneItem != null
								? {
										...
										shippingPriceInSubunitsOneItem:
											shippingPriceInSubunitsOneItem.amount,
										shippingPriceInSubunitsAdditionalItems:
