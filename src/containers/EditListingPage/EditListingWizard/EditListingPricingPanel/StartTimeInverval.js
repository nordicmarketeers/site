		...
		<fieldset className={css.root}>
			...
			<FieldRadioButton
				...
				label={intl.formatMessage({
					id: "StartTimeInterval.startEveryHour",
				})}
				value="hour"
			...
			<FieldRadioButton
				...
				className={css.option}
				label={intl.formatMessage({
					id: "StartTimeInterval.startEveryHalfHour",
				})}
				value="halfHour"
				showAsRequired={showAsPristine}
			/>
			...
			<FieldRadioButton
				...
				className={css.option}
				label={intl.formatMessage({
					id: "StartTimeInterval.startEveryQuarterHour",
				})}
				value="quarterHour"
				showAsRequired={showAsPristine}
			/>
