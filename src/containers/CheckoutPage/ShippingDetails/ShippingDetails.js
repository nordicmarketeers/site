		...
		<div className={classes}>
			...
			<FieldTextInput
				...
				label={intl.formatMessage({
					id: "ShippingDetails.recipientNameLabel",
				})}
				...
				validate={validators.required(
					intl.formatMessage({
						id: "ShippingDetails.recipientNameRequired",
					})
				)}
			...
			<FieldTextInput
				...
				onUnmount={() =>
					formApi.change("recipientPhoneNumber", undefined)
				}
			/>
			<div className={css.formRow}>
				<FieldTextInput
					...
					validate={validators.required(
						intl.formatMessage({
							id: "ShippingDetails.addressLine1Required",
						})
					)}
					onUnmount={() =>
				...
				<FieldTextInput
					...
					onUnmount={() =>
						formApi.change("recipientAddressLine2", undefined)
					}
				/>
			</div>
			<div className={css.formRow}>
				<FieldTextInput
					...
					label={intl.formatMessage({
						id: "ShippingDetails.postalCodeLabel",
					})}
					placeholder={intl.formatMessage({
					...
					validate={validators.required(
						intl.formatMessage({
							id: "ShippingDetails.postalCodeRequired",
						})
					)}
					onUnmount={() =>
						formApi.change("recipientPostal", undefined)
					}
				/>
				...
				<FieldTextInput
					...
					validate={validators.required(
						intl.formatMessage({
							id: "ShippingDetails.cityRequired",
						})
					)}
			...
			<div className={css.formRow}>
				<FieldTextInput
					...
					onUnmount={() =>
						formApi.change("recipientState", undefined)
					}
				/>
				...
				<FieldSelect
					...
					className={css.field}
					label={intl.formatMessage({
						id: "ShippingDetails.countryLabel",
					})}
					validate={validators.required(
						intl.formatMessage({
							id: "ShippingDetails.countryRequired",
						})
					)}
				>
					<option disabled value="">
						{intl.formatMessage({
							id: "ShippingDetails.countryPlaceholder",
						})}
					</option>
