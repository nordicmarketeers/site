	...
	blocks: [
		{
			...
			text: {
				fieldType: "markdown",
				content: addCodeBlockForSyntax(emphasisBold),
			},
		},
		{
			blockType: "defaultBlock",
			...
			text: {
				fieldType: "markdown",
				content: addCodeBlockForSyntax(emphasisBold2),
			},
		},
		{
			blockType: "defaultBlock",
			...
			text: {
				fieldType: "markdown",
				content: addCodeBlockForSyntax(emphasisItalic),
			},
		},
		{
			blockType: "defaultBlock",
			...
			text: {
				fieldType: "markdown",
				content: addCodeBlockForSyntax(emphasisItalic2),
			},
		},
	],
};
	...
	blocks: [
		{
			...
			text: {
				fieldType: "markdown",
				content: addCodeBlockForSyntax(horizontalRules),
			},
		},
		{
			blockType: "defaultBlock",
			...
			text: {
				fieldType: "markdown",
				content: addCodeBlockForSyntax(horizontalRules2),
			},
		},
		{
			blockType: "defaultBlock",
			...
			text: {
				fieldType: "markdown",
				content: addCodeBlockForSyntax(horizontalRules3),
			},
		},
	],
};
...
const SectionLists = {
	...
	blocks: [
		...
		},
		{
			...
			title: {
				fieldType: "heading3",
				content: 'Keep all numbers as "1."',
			},
			text: {
				fieldType: "markdown",
				content: `\`\`\`${orderedList2}\`\`\``,
			},
		},
		{
			blockType: "defaultBlock",
		...
		},
		{
			...
			title: {
				fieldType: "heading3",
				content: "Start numbering with offset",
			},
			text: {
				fieldType: "markdown",
				content: `\`\`\`${orderedList3}\`\`\``,
			},
		},
		{
			blockType: "defaultBlock",
	...
	blocks: [
		{
			...
			title: {
				fieldType: "heading3",
				content: 'With "alt" for screenreaders',
			},
	...
	blocks: [
		{
			...
			title: {
				fieldType: "heading3",
				content: "Inline code uses backticks",
			},
			text: {
				fieldType: "markdown",
				content: `\`\`\`${inlineCode}\`\`\``,
		...
		},
		{
			...
			title: {
				fieldType: "heading3",
				content: "Code block with indentation (4 spaces)",
			},
			text: {
				fieldType: "markdown",
				content: `\`\`\`${codeBlockIndentation}\`\`\``,
			},
		},
		{
			blockType: "defaultBlock",
...
const MyItalics = props => (
	<em style={{ color: "tomato", fontStyle: "italic" }} {...props} />
);
const MyStrong = props => (
	<strong style={{ color: "tomato", fontWeight: 700 }} {...props} />
);
