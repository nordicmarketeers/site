...
- The naming convention (i.e. _'Block'_ prefix) is just there to help to work with code editors and
  text suggestions.
...
- **_BlockMyComponent.js_**
  ...
  - There's a special component called BlockContainer, which should be used to wrap your component.
    For example:
    ```jsx
...
1. Inside BlockBuilder, there's a mapping between block type and component that can render it:
