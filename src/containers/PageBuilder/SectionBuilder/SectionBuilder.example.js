...
Vestibulum id ligula porta felis euismod semper. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.`,
						...
						callToAction: {
							fieldType: "externalButtonLink",
							href:
								"https://www.sharetribe.com/academy/marketplace-funding/",
				...
				blocks: [
					...
					},
					{
						...
						title: {
							fieldType: "heading3",
							content:
								"5 Nullam id dolor id nibh ultricies vehicula ut id elit.",
						},
						text: {
							fieldType: "markdown",
							content: `Donec id elit non mi porta gravida at eget metus. Etiam porta sem malesuada magna mollis euismod. Nullam quis risus eget urna mollis ornare vel eu leo. Praesent commodo cursus magna, vel scelerisque nisl consectetur et.`,
					...
					},
					{
						...
						title: {
							fieldType: "heading3",
							content:
								"7 Nullam id dolor id nibh ultricies vehicula ut id elit.",
						},
						text: {
							fieldType: "markdown",
							content: `Donec id elit non mi porta gravida at eget metus. Etiam porta sem malesuada magna mollis euismod. Nullam quis risus eget urna mollis ornare vel eu leo. Praesent commodo cursus magna, vel scelerisque nisl consectetur et.`,
					...
					},
					{
						...
						title: {
							fieldType: "heading3",
							content:
								"8 Nullam id dolor id nibh ultricies vehicula ut id elit.",
						},
						text: {
							fieldType: "markdown",
							content: `Donec id elit non mi porta gravida at eget metus. Etiam porta sem malesuada magna mollis euismod. Nullam quis risus eget urna mollis ornare vel eu leo. Praesent commodo cursus magna, vel scelerisque nisl consectetur et.`,
					...
					},
					{
						...
						title: {
							fieldType: "heading3",
							content:
								"9 Nullam id dolor id nibh ultricies vehicula ut id elit.",
						},
						text: {
							fieldType: "markdown",
							content: `Donec id elit non mi porta gravida at eget metus. Etiam porta sem malesuada magna mollis euismod. Nullam quis risus eget urna mollis ornare vel eu leo. Praesent commodo cursus magna, vel scelerisque nisl consectetur et.`,
		...
		sections: [
			{
				...
				title: {
					fieldType: "heading2",
					content: "One Column, No Blocks",
				},
				description: {
					fieldType: "paragraph",
					content:
						"Lorem ipsum dolor sit amet consectetur adepisci elit...",
				},
			},
			{
				sectionType: "columns",
			...
			},
			{
				...
				title: {
					fieldType: "heading2",
					content: "One Column, No Blocks, Bg Image",
				},
				description: {
					fieldType: "paragraph",
					content:
				...
				blocks: [
					{
						...
						callToAction: {
							fieldType: "internalButtonLink",
							href:
								"/l/wooden-sauna/5aafa4ec-87c1-4043-b82f-14d67389dd19",
			...
			},
			{
				...
				description: {
					fieldType: "paragraph",
					content: "Portrait images (400x500)",
				},
				blocks: [
					{
						blockType: "defaultBlock",
						...
						media: {
							fieldType: "image",
							alt: "First image",
							image: imagePlaceholder(400, 500),
						},
						title: { fieldType: "heading3", content: "Image 1" },
					},
					{
			...
			},
			{
				...
				description: {
					fieldType: "paragraph",
					content: "Landscape images (400x300)",
				},
				blocks: [
					{
						blockType: "defaultBlock",
						...
						media: {
							fieldType: "image",
							alt: "First image",
							image: imagePlaceholder(400, 300),
						},
						title: { fieldType: "heading3", content: "Image 1" },
					},
					{
