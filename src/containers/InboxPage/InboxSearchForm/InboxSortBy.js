...
const InboxSortBy = props => {
	...
	const iconArrowClassName = classNames(css.iconArrow, {
		[css.iconArrowAnimation]: isOpen,
	});

	const sortOptions = [
		{
			key: "createdAt",
			label: intl.formatMessage({ id: "InboxPage.sortBy.createdAt" }),
		},
		{
			key: "lastMessageAt",
		...
		},
		{
			...
			label: intl.formatMessage({
				id: "InboxPage.sortBy.lastTransitionedAt",
			}),
		},
	];
