...
export const ListingPageComponent = props => {
	...
	const noPayoutDetailsSetWithOwnListing =
		isOwnListing &&
		(authorNeedsPayoutDetails && !currentUser?.attributes?.stripeConnected);
		...
		>
			...
			>
				{showListingImage ? (
					...
					isOwnListing && (
						<div
							className={css.actionBarContainerForNoListingImage}
						>
							{actionBar}
						</div>
					)
				...
				<div className={css.contentWrapperForHeroLayout}>
					<div className={css.mainColumnForHeroLayout}>
						...
						<SectionAuthorMaybe
							...
							isInquiryModalOpen={
								isAuthenticated && inquiryModalOpen
							}
							onCloseInquiryModal={() =>
