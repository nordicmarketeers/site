...
const Offer = props => {
	...
	const previousOffer =
		isCustomerCounterOffer && previousOfferInSubunits
			...
			: null;
	const formattedPreviousOffer = previousOffer
		? formatMoney(intl, previousOffer)
		: "";
	const currentOffer = unitLineItem?.lineTotal
		? unitLineItem.lineTotal
		: null;
	const formattedCurrentOffer = currentOffer
		...
		<div className={classes}>
			...
			<TextMaybe
				heading={intl.formatMessage({
					id: "TransactionPage.Offer.providerDefaultMessageLabel",
				})}
