			...
			return (
				<Form className={classes} onSubmit={handleSubmit}>
					<FieldTextInput
						...
						id={
							formId
								? `${formId}.changeRequestMessage`
								: "changeRequestMessage"
						}
						name="changeRequestMessage"
						placeholder={intl.formatMessage({
							id: "RequestChangesForm.messagePlaceholder",
						})}
						validate={required(
							intl.formatMessage({
								id: "RequestChangesForm.messageRequired",
							})
						)}
					/>
	...
	return (
		<>
			...
			<p className={css.modalMessage}>
				<FormattedMessage
					id="RequestChangesModal.description"
