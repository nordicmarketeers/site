...
export const NoAccessPageComponent = props => {
	...
	const isUserPendingApprovalPage =
		missingAccessRight === NO_ACCESS_PAGE_USER_PENDING_APPROVAL;
	const isPostingRightsPage =
		missingAccessRight === NO_ACCESS_PAGE_POST_LISTINGS;
	const isInitiateTransactionsPage =
		missingAccessRight === NO_ACCESS_PAGE_INITIATE_TRANSACTIONS;
	const isViewingRightsPage =
		missingAccessRight === NO_ACCESS_PAGE_VIEW_LISTINGS;
	...
	const {
		...
		requirePermissionToInitiateTransactionsOptions: {
			callToAction: permissionToInitiateCTA,
		} = {},
		requirePermissionToPostListingsOptions: {
			callToAction: permissionToPostCTA,
		} = {},
		requirePermissionToReadOptions: {
			callToAction: permissionToViewCTA,
		} = {},
