	...
	return (
		<div className={css.typographyContent}>
			<p className={css.spacing2x}>
				The line-height of typographic elements is an multiple of 6px on
				mobile and multiple of 8px on desktop. In addition to
				line-height, baselines are adjusted with vertical padding (the
				sum of those paddings will be 6px on mobile or 8px on desktop).
				As a result one can position following typographic elements with
				margins that are also multiples of 6px (or 8px).
			</p>
			<p className={css.spacing2x}>
				N.B. box-sizing is border-box, so borders affect to the total
				height of elements.
			</p>
...
`}
				...
				<Font
					component={() => (
						<h5>
							H5: You will only be charged if your request is
				...
				<Font
					component={() => (
						<p>
							...
							malesuada magna mollis euismod. Aenean eu leo quam.
...
.myClass {
  composes: p from global;
				...
				<Font
					component={() => (
						<p className={css.tinyFont}>Hosted by user</p>
					)}
					description={`.myClass {
