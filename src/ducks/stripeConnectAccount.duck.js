...
///////////////////////////
const createStripeAccountPayloadCreator = (
	params,
	{ extra: sdk, rejectWithValue }
) => {
	if (typeof window === "undefined" || !window.Stripe) {
		throw new Error(
			"Stripe must be loaded for submitting PayoutPreferences"
		);
	}
	const {
		country,
...
///////////////////////////
const updateStripeAccountPayloadCreator = (
	params,
	{ extra: sdk, rejectWithValue }
) => {
...
//////////////////////////
const fetchStripeAccountPayloadCreator = (
	params,
	{ extra: sdk, rejectWithValue }
) => {
	return sdk.stripeAccount
...
/////////////////////////////////////
const getStripeConnectAccountLinkPayloadCreator = (
	params,
	{ extra: sdk, rejectWithValue }
) => {
...
const stripeConnectAccountSlice = createSlice({
	...
	extraReducers: builder => {
		builder
			...
			.addCase(
				getStripeConnectAccountLinkThunk.rejected,
				(state, action) => {
					console.error(action.payload);
					state.getAccountLinkInProgress = false;
