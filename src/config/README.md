...
1. Pass those as hostedTranslations and hostedConfig to the App
1. src/app.js then saves those to the correct React Contexts
1. Page-specific data loading calls
1. Render the App
