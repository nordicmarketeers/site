...
if (typeof window !== "undefined") {
	...
	const baseUrl = appSettings.sdk.baseUrl
	...
	const googleAnalyticsIdFromSSR =
		initialState?.hostedAssets?.googleAnalyticsId;
	const googleAnalyticsId =
		googleAnalyticsIdFromSSR || process.env.REACT_APP_GOOGLE_ANALYTICS_ID;
