...
describe("generators and iterators", () => {
	describe("uniqueBy(arr, f)", () => {
		it("should remove duplicates according to given by-function", () => {
			...
			expect(JSON.stringify(uniqArr)).toEqual(
		...
		it("should ", () => {
			...
			const expectedResult = JSON.stringify([
				...
				},
				{
					...
					end: "2023-01-10T08:00:00.000Z",
				},
				{
					start: "2023-01-10T17:00:00.000Z",
					end: "2023-01-15T00:00:00.000Z",
				},
				{
					start: "2023-01-17T00:00:00.000Z",
	...
	describe("availabilityPerDate(start, end, plan, exceptions)", () => {
		it("should return dates until end date, and map entries, exceptions to them", () => {
			...
			const exceptions = [
				{
					attributes: {
						start: parseDateFromISO8601(
							"2023-01-02",
							"Europe/Helsinki"
						),
						end: parseDateFromISO8601(
							"2023-01-03",
							"Europe/Helsinki"
						),
						seats: 0,
        ...
        "2023-01-04": {
          ...
          "hasAvailability": true
			...
			const dateInfoHashMap = availabilityPerDate(
				start,
				end,
				plan,
				exceptions
	...
	describe("timeSlotsPerDate(start, end, timeSlots, timeZone, options)", () => {
        ...
        "2023-01-04": {
          ...
          "hasAvailability": false
			...
			const dateInfoHashMap = timeSlotsPerDate(
				start,
				end,
				timeSlots,
				timeZone,
