...
describe("validators", () => {
	...
	describe("uniqueString()", () => {
		...
		it("should not allow undefined", () => {
			expect(
				uniqueString(0, stringArray, getMessage, toSlug)(undefined)
			).toEqual("fail");
			expect(uniqueString(1, stringArray, getMessage, toSlug)()).toEqual(
				"fail"
			);
		});
		it("should not allow non-unique strings", () => {
			expect(
				uniqueString(1, stringArray, getMessage, toSlug)("foo")
			).toEqual("fail");
		});
		it("should allow unique strings", () => {
			expect(
				uniqueString(1, stringArray, getMessage, toSlug)("")
			).toBeUndefined();
			expect(
				uniqueString(1, stringArray, getMessage, toSlug)("asdf")
			).toBeUndefined();
			expect(
				uniqueString(1, stringArray, getMessage, toSlug)("fo")
			).toBeUndefined();
		});
	});
	describe("requiredSelectTreeOption()", () => {
		...
		it("should allow empty object as value", () => {
			expect(
				requiredSelectTreeOption("fail")({ nestedLevel1: "foobar" })
			).toBeUndefined();
		});
	});
	describe("minLength()", () => {
	...
	describe("moneySubUnitAmountAtLeast()", () => {
		it("should not allow empty or missing value", () => {
			expect(moneySubUnitAmountAtLeast("fail", 50)(undefined)).toEqual(
				"fail"
			);
		...
		it("should not allow too low values", () => {
			expect(
				moneySubUnitAmountAtLeast("fail", 50)(new Money(0, "USD"))
			).toEqual("fail");
			expect(
				moneySubUnitAmountAtLeast("fail", 50)(new Money(49, "USD"))
			).toEqual("fail");
		});
		it("should allow large enough values", () => {
			expect(
				moneySubUnitAmountAtLeast("fail", 0)(new Money(0, "USD"))
			).toBeUndefined();
			expect(
				moneySubUnitAmountAtLeast("fail", 50)(new Money(50, "USD"))
			).toBeUndefined();
			expect(
				moneySubUnitAmountAtLeast("fail", 50)(new Money(100, "USD"))
			).toBeUndefined();
		});
	});
	describe("validBusinessURL()", () => {
		...
		it("should fail on http://example.com", () => {
			expect(validBusinessURL("fail")("http://example.com")).toEqual(
				"fail"
			);
		});
		...
		it("should fail on http://localhost", () => {
			expect(validBusinessURL("fail")("http://localhost/")).toEqual(
				"fail"
			);
		});
		...
		it("should fail on <localhosttunnel.com>", () => {
			expect(validBusinessURL("fail")("<localhosttunnel.com>")).toEqual(
				"fail"
			);
		});
		it("should allow on localhosttunnel.com", () => {
			expect(
				validBusinessURL("fail")("localhosttunnel.com")
			).toBeUndefined();
		});
		it("should allow on http://localhosttunnel.com", () => {
			expect(
				validBusinessURL("fail")("http://localhosttunnel.com")
			).toBeUndefined();
		});
		it("should allow on https://localhosttunnel.com", () => {
			expect(
				validBusinessURL("fail")("https://localhosttunnel.com")
			).toBeUndefined();
		});
	});
	describe("composeValidators()", () => {
		const validateLength = composeValidators(
