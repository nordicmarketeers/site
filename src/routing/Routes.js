...
const canShowComponent = props => {
	...
	return (
		!auth ||
		(isAuthenticated && !isBanned(currentUser) && !accountMarkedDeleted)
	);
};
...
class RouteComponentRenderer extends Component {
	...
	render() {
		...
		const isBannedFromAuthPages =
			restrictedPageWithCurrentUser && isBanned(currentUser);
		return canShow ? (
